...
const LINE_BANKS: Record<string, string[]> = {
  ...
  '范范兔': ['海南鸡饭加辣椒酱…shiok 到飞起 (≧▽≦)', '又赶 A1 巴士,腿都跑细了 (>﹏<)', 'Kaya toast 配半熟蛋,原地复活 ✧*。', '夜间动物园的马来貘超萌!(｡･ω･｡)', '纸巾 chope 一下~这桌我的咯 (・∀・)', 'Eh 你吃了没?食阁见呀 ♪(´▽`)', 'Supertree 灯光秀,免费的快乐 (✿◡‿◡)', '蹦蹦跳跳,元气满满的一天 ٩(•̀ω•́)و', '穿山甲卷成球球,想带回家 (>ω<)', '今天也要恰好多好吃的 (๑˃ᴗ˂)ﻭ', '辣椒蟹满手酱也要吃!(＞ڡ＜)', 'laksa 还是鸡饭…都要 lah (´°ω°`)'],
