...
const LINE_BANKS: Record<string, string[]> = {
  ...
  '范范兔': ['今天也要元气满满地搬砖鸭 ٩(•̀ω•́)و', '刚上班就被会议轰炸,还是笑嘻嘻 (≧▽≦)', '同事别 emo,抱抱,你超棒的!(っ´ω`)ﻭ', '午饭去食阁,海南鸡饭 shiok 飞起 (＞ڡ＜)', 'OT 到深夜?那就去夜间动物园回血 (｡･ω･｡)', '发薪日!请大家喝 teh tarik ♪(´▽`)', '马来貘黑白两截,可爱到尖叫 (✿◡‿◡)', '加油哦~你今天已经很努力啦 (◍•ᴗ•◍)', 'MRT 挤归挤,微笑不能少 (・∀・)', '紫色丸子头,今天也很可爱吧?(ฅ•ω•ฅ)', '笑一个嘛!烦恼都会跑掉的 (◕ᴗ◕✿)', '下班冲去看 Supertree 灯光秀 ✧*。'],
